  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-white pt-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <p className="text-sm font-medium tracking-wider uppercase mb-6">{props.data?.slogan || t("hero.slogan")}</p>

        <h1 className="font-display font-bold text-7xl sm:text-7xl lg:text-8xl uppercase leading-tight mb-4 max-w-5xl mx-auto">
          <span className="">{props.data?.title || t("hero.title")}</span> <br />
        </h1>
        <h2 className="font-light text-2xl sm:text-3xl lg:text-4xl mb-12 leading-tight">{props.data?.subtitle || t("hero.subtitle")}</h2>
